...
export default function ValutaCasaClient() {
        ...
        <div className="grid lg:grid-cols-[1.1fr_1.6fr] gap-8">
          ...
          <div className="bg-white py-8 px-6 border border-primary/10 shadow-lg shadow-primary/10 rounded-2xl sm:px-10">
            ...
            >
              ...
              <div className="pt-4">
                <label className="flex items-start gap-2.5 rounded-2xl border border-primary/10 bg-white px-4 py-3.5 text-sm leading-relaxed text-secondary/85 sm:gap-3 sm:px-5 sm:py-4">
                  <input
                    type="checkbox"
                    name="privacyAccepted"
                    checked={formData.privacyAccepted}
                    onChange={handleChange}
                    className="mt-0.5 h-3.5 w-3.5 flex-shrink-0 rounded border-primary/30 text-primary focus:ring-primary/30 sm:mt-1 sm:h-4 sm:w-4"
                  />
                  <span className="min-w-0 text-sm sm:text-[15px]">
                ...
                <button
                  ...
                  className={`mt-5 w-full flex justify-center py-3.5 px-4 rounded-xl font-bold text-white bg-primary hover:bg-primary/90 transition-all btn-glow sm:mt-6 ${
                ...
                <div className="mt-4 rounded-2xl border border-primary/10 bg-primary/5 px-4 py-4 text-sm leading-relaxed text-secondary/85 sm:px-5">
