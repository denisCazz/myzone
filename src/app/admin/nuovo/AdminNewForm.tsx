          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div className="sm:col-span-2">
                ...
                <input id="titolo" name="titolo" required className={inputClass} placeholder="Es. Appartamento luminoso in centro" />
              </div>

              <div>
                <label htmlFor="categoria" className="block text-sm font-medium text-secondary mb-1">Categoria *</label>
                <input id="categoria" name="categoria" defaultValue="RESIDENZIALE" required className={inputClass} />
              </div>

              <div>
                <label htmlFor="tipologia_immobile" className="block text-sm font-medium text-secondary mb-1">Tipologia immobile *</label>
                <input id="tipologia_immobile" name="tipologia_immobile" placeholder="Casa indipendente" required className={inputClass} />
              </div>

              <div>
                <label htmlFor="tipo_contratto" className="block text-sm font-medium text-secondary mb-1">Tipo contratto *</label>
                <select id="tipo_contratto" name="tipo_contratto" defaultValue="IN VENDITA" className={inputClass}>
              ...
              <div>
                ...
                <select id="stato" name="stato" defaultValue="DISPONIBILE" className={inputClass}>
              ...
              <div>
                ...
                <input id="prezzo" name="prezzo" type="number" min="0" required className={inputClass} placeholder="0" />
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-3">
                  ...
                  <input id="immagine_url" name="immagine_url" type="url" className={inputClass} placeholder="https://..." />
                </div>
              </div>

              <div className="sm:col-span-2">
                <label htmlFor="descrizione" className="block text-sm font-medium text-secondary mb-1">Descrizione *</label>
                <textarea id="descrizione" name="descrizione" rows={6} required className={inputClass} placeholder="Descrivi l'immobile..." />
              </div>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
              <div>
                ...
                <input id="provincia" name="provincia" defaultValue="CUNEO" required className={inputClass} />
              </div>
              <div>
                <label htmlFor="comune" className="block text-sm font-medium text-secondary mb-1">Comune *</label>
                <input id="comune" name="comune" required className={inputClass} placeholder="Cavallermaggiore" />
              </div>
              <div>
                <label htmlFor="indirizzo" className="block text-sm font-medium text-secondary mb-1">Indirizzo *</label>
                <input id="indirizzo" name="indirizzo" required className={inputClass} placeholder="Via Roma 1" />
              </div>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
              <div>
                ...
                <input id="numero_locali" name="numero_locali" type="number" min="0" defaultValue={0} required className={inputClass} />
              </div>
              <div>
                <label htmlFor="superficie_mq" className="block text-sm font-medium text-secondary mb-1">Superficie m² *</label>
                <input id="superficie_mq" name="superficie_mq" type="number" min="0" defaultValue={0} required className={inputClass} />
              </div>
              <div>
                <label htmlFor="bagni" className="block text-sm font-medium text-secondary mb-1">Bagni</label>
                <input id="bagni" name="bagni" type="number" min="0" defaultValue={0} className={inputClass} />
              </div>
              <div>
                <label htmlFor="piano" className="block text-sm font-medium text-secondary mb-1">Piano</label>
                <input id="piano" name="piano" placeholder="--" className={inputClass} />
              </div>
              <div>
                <label htmlFor="ape" className="block text-sm font-medium text-secondary mb-1">APE</label>
                <input id="ape" name="ape" className={inputClass} />
              </div>
              <div>
                <label htmlFor="ipe" className="block text-sm font-medium text-secondary mb-1">IPE</label>
                <input id="ipe" name="ipe" type="number" min="0" step="0.01" className={inputClass} />
              </div>
              <div>
                <label htmlFor="riscaldamento" className="block text-sm font-medium text-secondary mb-1">Riscaldamento</label>
                <input id="riscaldamento" name="riscaldamento" className={inputClass} />
              </div>
              <div>
                <label htmlFor="tipo_riscaldamento" className="block text-sm font-medium text-secondary mb-1">Tipo riscaldamento</label>
                <input id="tipo_riscaldamento" name="tipo_riscaldamento" className={inputClass} />
              </div>
              <div>
                <label htmlFor="sistema_radiante" className="block text-sm font-medium text-secondary mb-1">Sistema radiante</label>
                <input id="sistema_radiante" name="sistema_radiante" className={inputClass} />
              </div>
              <div>
                <label htmlFor="cucina" className="block text-sm font-medium text-secondary mb-1">Cucina</label>
                <input id="cucina" name="cucina" className={inputClass} />
              </div>
              <div>
                <label htmlFor="box" className="block text-sm font-medium text-secondary mb-1">Box</label>
                <input id="box" name="box" className={inputClass} />
              </div>
            </div>
            <div className="flex flex-wrap gap-6 pt-2">
              <label className="inline-flex items-center gap-2.5 text-sm text-secondary cursor-pointer">
                <input type="checkbox" name="giardino" className="h-4 w-4 rounded border-primary/20 text-primary focus:ring-primary/30" />
                Giardino
              </label>
              <label className="inline-flex items-center gap-2.5 text-sm text-secondary cursor-pointer">
                <input type="checkbox" name="terrazzo" className="h-4 w-4 rounded border-primary/20 text-primary focus:ring-primary/30" />
                Terrazzo
              </label>
              <label className="inline-flex items-center gap-2.5 text-sm text-secondary cursor-pointer">
                <input type="checkbox" name="ascensore" className="h-4 w-4 rounded border-primary/20 text-primary focus:ring-primary/30" />
                Ascensore
              </label>
            </div>
          </section>
